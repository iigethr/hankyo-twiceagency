      ...
      <div className="grid center-h">
        <div className="grid-box">
          <div className="grid-row">
            <h1 className="font-xxl text-center orange-500-cl">Partners & Expertise</h1>
          ...
          <div className="grid-row">
            ...
            <a href="https://twice-agency.com/lifestyle/services/" className="button-xxl orange center-h" rel="noreferrer" target="_blank">
