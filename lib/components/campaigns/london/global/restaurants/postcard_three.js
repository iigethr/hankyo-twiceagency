...
// Assets
import BackgroundImage from "../../../../../../assets/images/campaigns/london/global/restaurants/panel-three.jpg";
import BackgroundImageV from "../../../../../../assets/images/campaigns/london/global/restaurants/panel-three-vertical.jpg";
          ...
          <div className="postcard-row">
            <div className="postcard-right fill white-bg">
              <form className="form white-bg" id="form" action="https://submit-form.com/G6AXDTY6foZrW1yQ3HdYR" target="_self" >
                ...
                <input type="hidden" name="subject" value="London Restaurants - Global" />
                <fieldset>
                    ...
                    <div className="form-item">
                      <div className="gdpr">
                        <label htmlFor="checkbox">
                          <input type="checkbox" id="checkbox" name="gdpr" value="consent" required />
                          <span className="checkmark"></span>
                            I confirm that I have read and agree with Twice Agency’s <a href="https://twice-agency.com/terms-conditions/" className="orange-dark underline" rel="noreferrer">T&Cs</a> and <a href="https://twice-agency.com/privacy-policy/" className="orange-dark underline" rel="noreferrer">Privacy Policy</a>
                        </label>
                      </div>
                    </div>
                  </div>
