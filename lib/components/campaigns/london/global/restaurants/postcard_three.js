            ...
            <div className="postcard-right fill white-bg">
              <form className="form white-bg" id="form" action="https://submit-form.com/2oYndgWgARb5SnNwEtMSR" target="_self" >
                ...
                <fieldset>
                  ...
                  <hr className="separator-xs" />
                  <div className="form-row">
                    <p className="font-m text-center gray-500-cl">You can also visit <a href="https://www.twice-agency.com/privacy-policy/" className="orange-dark bold underline" rel="noreferrer">our website</a> for more information.</p>
                  </div>
                </fieldset>
              </form>
            </div>
