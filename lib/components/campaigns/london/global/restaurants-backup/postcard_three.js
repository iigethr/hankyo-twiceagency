            ...
            <div className="postcard-right fill white-bg">
              <form className="form white-bg" id="form" action="https://submit-form.com/G6AXDTY6foZrW1yQ3HdYR" target="_self" >
                ...
                <fieldset>
                  ...
                  <hr className="separator-xs" />
                  <div className="form-row">
                    <p className="font-m text-center gray-500-cl">You can also visit <a href="https://twice-agency.com/lifestyle/services/" className="orange-dark bold underline" rel="referrer">our website</a> for more information.</p>
                  </div>
                </fieldset>
              </form>
            </div>
