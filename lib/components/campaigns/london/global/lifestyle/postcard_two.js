        ...
        <div className="postcard-box responsive">
          <div className="postcard-row">
            <div className="postcard-left fill white-bg">
              <p className="font-xl text-center orange-500-cl uppercase">Brilliantly Personal & Detailed</p>
              <hr className="separator-xs" />
              <p className="font-m text-center gray-300-cl">
                Whether you are an individual looking for assistance with your busy life or a corporate looking for unique business benefits we are here to assist. Our mission: enhance our members’ day-to-day life and fulfill their biggest dreams.
              </p>
