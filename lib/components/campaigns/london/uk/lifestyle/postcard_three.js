            ...
            <div className="postcard-right fill white-bg">
              <form className="form white-bg" id="form" action="https://submit-form.com/G6AXDTY6foZrW1yQ3HdYR" target="_self" >
                ...
                <fieldset>
                  ...
                  <p className="font-m gray-500-cl">Please submit your details below and one of our Lifestyle experts will be in touch shortly.</p>
        ...
        <style jsx>{`
          ...
          @media screen and (max-width: 959px) {
            .postcard-box {
              ...
              background-size: 448px 476px !important;
