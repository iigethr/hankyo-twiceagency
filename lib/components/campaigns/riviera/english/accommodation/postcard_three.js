          ...
          <div className="postcard-row">
            <div className="white-bg">
              <form className="form white-bg" id="form" action="https://submit-form.com/G6AXDTY6foZrW1yQ3HdYR" target="_self" >
                ...
                <input type="hidden" name="subject" value="Riviera - English" />
                <fieldset>
                  <legend className="orange-500-cl">GET IN TOUCH</legend>
                  <p className="font-s gray-500-cl">Please submit your details below and one of our Estate experts will be in touch shortly.</p>
                  ...
                  <div className="form-row">
                    <div className="form-item half left">
                      ...
                      <div className="select">
                        <select type="text" name="need" autoComplete="off" required >
                          ...
                          <option value="volvo">Holiday rental</option>
                          <option value="saab">Congress rental</option>
                          <option value="mercedes">Business accommodation</option>
                          <option value="audi">Long let</option>
                          <option value="audi">Property for sale</option>
                    ...
                    <div className="form-item half right">
                      ...
                      <div className="select">
                        <select type="text" name="location" autoComplete="off" required >
                          <option disabled selected value="- -"> - - </option>
                          <option value="volvo">Cannes area</option>
                          <option value="saab">St Tropez area</option>
                          <option value="audi">Monaco area</option>
                          <option value="audi">I’m not sure</option>
                        </select>
                      </div>
                      {/* <p className="label-reference gray-300-cl">Please select an option</p> */}
                    </div>
