          ...
          <div className="postcard-row">
            <div className="postcard-left fill white-bg">
              ...
              <ul className="gray-500-cl">
                ...
                <li><strong>Stressless stay</strong> - Let our in-house five-star concierge service take care of everything, from transfer, reservations to staffing for your luxury property.</li>
