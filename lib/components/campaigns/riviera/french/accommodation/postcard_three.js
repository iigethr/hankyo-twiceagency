            ...
            <div className="white-bg">
              <form className="form white-bg" id="form" action="https://submit-form.com/G6AXDTY6foZrW1yQ3HdYR" target="_self" >
                ...
                <fieldset>
                  ...
                  <p className="font-m gray-500-cl">Veuillez soumettre vos coordonnées ci-dessous et l'un de nos experts vous contactera rapidement ou appelez nous au <a href="tel:+33 (0)4 22 8400 13">+33 (0)4 22 8400 13</a>.</p>
