          ...
          <div className="postcard-row">
            <div className="white-bg">
              <form className="form white-bg" id="form" action="https://submit-form.com/G6AXDTY6foZrW1yQ3HdYR" target="_self" >
                ...
                <input type="hidden" name="subject" value="Riviera - French" />
                <fieldset>
                  ...
                  <p className="font-s gray-700-cl chip">Agence de Cannes: <a href="tel:+33422840013">+33 (0)4 22 8400 13</a></p>
                  <p className="font-s gray-700-cl chip">Agence de Londres: <a href="tel:+442034111876">+44 (0)203 4111 876</a></p>
                  <p className="font-s gray-700-cl chip">WhatsApp: <a href="tel:+447503264532">+44 (0)7503 264 532</a></p>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-item half right">
                      ...
                      <div className="input">
                        <input type="text" name="contact" autoComplete="off" placeholder="+33" />
                      </div>
                    </div>
                  </div>
