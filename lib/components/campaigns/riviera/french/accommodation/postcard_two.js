          ...
          <div className="postcard-row">
            <div className="postcard-left fill white-bg">
              ...
              <ul className="gray-500-cl">
                <li><strong>Sélection</strong> - Nous travaillons en étroite collaboration avec nos partenaires immobiliers locaux afin de sélectionner pour vous les propriétés les plus exclusives en location et en ventes sur la Côte d'Azur.</li>
                ...
                <li><strong>Conciergerie in-house</strong> - Notre service de conciergerie 5* s’occupe de tout, vos transferts, réservations et du personnel pour votre propriété de luxe.</li>
                <li><strong>Expériences sur-mesure</strong> - Du divertissement pour vos clients aux activités familiales, vivez la Côte d'Azur comme jamais auparavant grâce à notre équipe d'experts locaux.</li>
              </ul>
              <hr className="separator-s" />
