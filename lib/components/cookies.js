        ...
        <div className={klass}>
          <div className="cookies-box `#{klass}`">
            <div className="cookies-row">
              ...
              <p className="font-s text-center">For more information you can visit our <a href="https://www.twice-agency.com/privacy-policy/" target="_blank" rel="noreferrer">Policies & Terms</a> section.</p>
            </div>
            <div className="cookies-row">
              <Link href="/">
